...
export default function TermosDeUso() {
  ...
  const gerarPDF = () => {
    ...
    doc.setFontSize(16);
    doc.text('TERMOS DE USO E POLÍTICA DE PRIVACIDADE - SIGAP', 105, 20, { align: 'center' });
    ...
    const conteudo = [
      ...
      'O SIGAP coleta e processa dados necessários para sua operação, incluindo:',
      ...
      'Os dados coletados pelo SIGAP são utilizados exclusivamente para:',
      ...
      'O SIGAP poderá compartilhar dados com:',
      ...
      'O SIGAP implementa medidas técnicas e administrativas para proteger os dados processados, incluindo:',
      ...
      'Ao utilizar o SIGAP, o usuário compromete-se a:',
      ...
      'O fornecedor do SIGAP não será responsável por:',
      ...
      'O SIGAP, incluindo seu código-fonte, interface, design e conteúdos, é protegido por direitos de propriedade intelectual. É vedada a cópia, modificação, distribuição ou engenharia reversa do sistema sem autorização expressa do fornecedor.',
      '',
      ...
      'Estes Termos de Uso e Política de Privacidade constituem o acordo integral entre as partes em relação ao uso do SIGAP. Em caso de dúvidas ou esclarecimentos, o usuário deve contatar o administrador do sistema na entidade contratante.',
      '',
    ...
    // Salvar o PDF
    doc.save('termos-de-uso-sigap.pdf');
  };
  ...
  return (
    <div className="w-full">
      ...
      <div ref={termoRef} className="bg-c_deep_middle_black p-6 rounded-lg border border-gray-700 shadow-lg text-sm">
        <h1 className="text-xl font-bold mb-6 text-center">TERMOS DE USO E POLÍTICA DE PRIVACIDADE - SIGAP</h1>
        
        <h2 className="text-lg font-bold mt-6 mb-3 text-blue-400">SISTEMA INTEGRADO DE GESTÃO E APREENSÃO PATRIMONIAL (SIGAP)</h2>
        
        <h3 className="text-md font-bold mt-5 mb-2">1. DEFINIÇÃO E ESCOPO</h3>
        <p className="mb-4">
          O Sistema Integrado de Gestão e Apreensão Patrimonial (SIGAP) é uma plataforma digital desenvolvida para gerenciar, 
        ...
        <p className="mb-4">
          Os Termos de Uso do SIGAP são estritamente direcionados ao contrato estabelecido entre a empresa ou Órgão Público 
        ...
        <p className="mb-4">
          O SIGAP, incluindo seu código-fonte, interface, design e conteúdos, é protegido por direitos de propriedade intelectual. 
