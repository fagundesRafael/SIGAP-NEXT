// components/DocumentosTable.js
"use client";

import Link from "next/link";

export default function DocumentosTable({ records }) {
  return (
      ...
      <tbody>
        {records.map((v) => (
          <tr key={v._id} className="text-[10px]">
            ...
            <td className="border border-c_deep_black bg-c_deep_gray_black text-center p-1">{v.obs}</td>
